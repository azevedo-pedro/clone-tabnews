...
async function status(request, response) {
  ...
  const databaseMaxConnectionCountValue = await database.query("SHOW max_connections;")
  ...
  response.status(200).json({
    ...
    dependenciees: {
      database: {
        ...
        max_connections: parseInt(databaseMaxConnectionCountValue.rows[0].max_connections),
